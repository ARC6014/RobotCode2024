...
public class OperatorTab extends ShuffleboardTabBase{
    ...
    private GenericEntry boreAngle, falconAngle, armState, atSetpoint, atZero, motMagStatus, lastRotation, current, voltage;
    ...
    public void update() {
        ...
        motMagStatus.setBoolean(mArm.getArmMotor().getMotionMagicIsRunning().getValue() == MotionMagicIsRunningValue.Enabled);
