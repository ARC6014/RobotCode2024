...
public class RotateToSpeaker extends Command {
  ...
  // SimpleMotorFeedforward(DriveConstants., 0, 0)
  ...
  @Override
  public void execute() {
    tethaSpeed = m_thetaController.calculate(mDrive.getPose().getRotation().getDegrees(),
        targetAngle);

    mDrive.swerveDrive(0, 0, Units.degreesToRadians(tethaSpeed), true);
