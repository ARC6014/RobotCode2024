...
public class CANdleLed extends SubsystemBase {
  ...
  public void changeAnimation(AnimationTypes toChange) {
        ...
        {
            case ColorFlow:
                m_toAnimate = new ColorFlowAnimation(128, 20, 70, 0, 0.7, Constants.LEDConstants.BUFFER_LENGTH, Direction.Forward);
                break;
            case Fire:
                m_toAnimate = new FireAnimation(0.5, 0.7, Constants.LEDConstants.BUFFER_LENGTH, 0.7, 0.5);
                break;
            case Larson:
                m_toAnimate = new LarsonAnimation(0, 255, 46, 0, 1, Constants.LEDConstants.BUFFER_LENGTH, BounceMode.Front, 3);
                break;
            case Rainbow:
            ...
            case Strobe:
                ...
                break;
            case Twinkle:
                m_toAnimate = new TwinkleAnimation(30, 70, 60, 0, 0.4, Constants.LEDConstants.BUFFER_LENGTH, TwinklePercent.Percent6);
                break;
            case TwinkleOff:
                m_toAnimate = new TwinkleOffAnimation(70, 90, 175, 0, 0.8, Constants.LEDConstants.BUFFER_LENGTH, TwinkleOffPercent.Percent100);
                break;
            case SetAll:
                m_toAnimate = null;
                break;
