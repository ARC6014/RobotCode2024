...
// Quick Info about these classes:
// * Translation2d: (x,y)
// * Rotation2d: (theta)
// * Pose2d: (x,y,theta)
// * Transform2d: (InitialPose2d, FinalPose2d)
// * Twist2d: (dx,dy,dtheta) A change in distance along a 2D arc since the last pose update
